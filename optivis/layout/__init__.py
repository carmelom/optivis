...
class AbstractLayout(with_metaclass(abc.ABCMeta, object)):
    title = "Abstract"
    ...
    def arrange(self):
        ...
        # self.linkedComponents = set([])  # sets cannot contain mutable objects
        self.linkedComponents = list()
    ...
    def layoutLinkChain(self, link, referenceComponent):
        ...
        self.linkedComponents.append(referenceComponent)
        self.linkedComponents.append(targetComponent)
